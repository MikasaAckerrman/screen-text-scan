    ...
    protected void onCreate(Bundle b) {
        ...
        root.addView(body(
                "Как это работает:\n"
                        ...
                        + "4. ОДИНОЧНЫЙ тап по кружку — скопировать накопленное и "
                        + "продолжить чтение.\n"
                        + "5. ДВОЙНОЙ тап — закончить: откроется список, где строки "
                        + "можно исправить, лишние исключить, всё перевести.\n"
                        + "6. Долгое нажатие (2,5 с) — убрать кружок без списка; "
                        + "прочитанное всё равно уйдёт в буфер обмена.\n"
                        + "Если чтение само остановилось (таймаут тишины или выход "
                        + "на рабочий стол) — накопленное тоже копируется, ничего "
                        + "не пропадает."));
